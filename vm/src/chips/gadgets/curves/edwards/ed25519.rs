...
use crate::chips::gadgets::{
    ...
    utils::field_params::{FieldParameters, NumLimbs},
};
...
mod tests {
    ...
    #[test]
    fn test_ed25519_decompress() -> anyhow::Result<()> {
        ...
        for _ in 0..NUM_TEST_CASES {
            ...
            let decompressed_point = decompress(&compressed_point).unwrap();
            assert_eq!(point, decompressed_point);
